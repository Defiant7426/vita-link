    ...
    <div className="relative">
        <div className="relative max-w-7xl py-32 mx-auto px-8 z-30">
            <div className="max-w-[400px] text-white">
                <h1 className="text-6xl font-semibold leading-tight">Bienvenido, Luis</h1>
        ...
        <video autoPlay loop muted
            ...
            <source src="https://vitalink.nyc3.cdn.digitaloceanspaces.com/vitalink2.mp4" type="video/mp4" />
        </video>
    </div>
  )
}
